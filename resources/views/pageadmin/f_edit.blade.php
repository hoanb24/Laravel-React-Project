        ...
        <div class="container">
            <form action="admin-edit" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="editId" value="{{ $product->id }}"
                        readonly>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" min=10000 class="form-control" name="editPrice" id="editPrice"
                        placeholder="Enter price" value="{{ $product->unit_price }}" required>
                    </div>

                <div class="form-group">
                    <label for='editPromotionPrice'>Promotion Price</label>
                    <input type="number" min=10000 class="form-control" name="editPromotionPrice"
                        id="editPromotionPrice" value="{{ $product->promotion_price }}" placeholder="Enter promotion price">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" min=0 class="form-control" name="editNew" id="editNew"
                        value="{{ $product->new }}" placeholder="Enter new" required>
                    </div>

                <div class="form-group">
                    <label for='editType'>Type</label>
                    <input type="text" class="form-control" name="editType" id="editType"
                        value="{{ $product->id_type }}" placeholder="Enter type" required>
                    </div>
                ...
                <div class="form-group">
                    <img id="preview-image-before-upload" src="source/image/product/{{ $product->image }}"
