        ...
        <div class="container">
            <form action="admin-add-form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min=10000 class="form-control" name="inputPromotionPrice"
                        id="inputPromotionPrice" placeholder="Enter promotion price">
                    </div>

                <div class="form-group">
                    <label for='inputUnit'>Unit</label>
                    <input type="text" class="form-control" name="inputUnit" id="inputUnit"
                        placeholder="Enter unit" required>
                    </div>

                <div class="form-group">
                    <label for='inputNew'>New</label>
                    <input type="number" min=0 class="form-control" name="inputNew" id="inputNew"
                        placeholder="Enter new" required>
                    </div>
