        ...
        <div class="container">
            ...
            <div class="pull-right">
                <div class="beta-breadcrumb font-large">
                    <a href="/page">Home</a> / <span>Sản phẩm</span>
                    </div>
                </div>
                                            ...
                                            <div class="single-item-body">
                                                ...
                                                <p class="single-item-price"
                                                    ...
                                                    @else
                                                        ...
                                                        <span
                                                            class="flash-sale">{{ number_format($sp->promotion_price) }}
                                                            Đồng</span>
                                                    @endif
                                                    </p>
                                                </div>
                                            ...
                                            <div class="single-item-body">
                                                ...
                                                <p class="single-item-price"
                                                    ...
                                                    @else
                                                        ...
                                                        <span
                                                            class="flash-sale">{{ number_format($khac->promotion_price) }}
                                                            Đồng</span>
                                                    @endif
                                                    </p>
                                                </div>
